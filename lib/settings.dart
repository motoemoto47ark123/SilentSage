        ...
        return Scaffold(
          appBar: AppBar(
            ...
            backgroundColor: isDark
                ? Colors.black
                : Colors.white, // Dynamic background color based on theme.
          ),
          body: Center(
            child: Column(
              ...
              children: <Widget>[
                Text(
                  ...
                  style: TextStyle(
                      ...
                      color: isDark
                          ? Colors.red
                          : Colors.red), // Text style with dynamic color.
                ),
                Switch(
                  ...
                  activeTrackColor: Colors.black.withOpacity(
                      0.5), // Track color when the switch is active.
                  activeColor: Colors
                      .black, // Color of the thumb when the switch is active.
                  materialTapTargetSize: MaterialTapTargetSize
                      .padded, // Increases tap target size for accessibility.
                  thumbColor: isDark
                      ? MaterialStateProperty.all(Colors.white)
                      : MaterialStateProperty.all(
                          Colors.black), // Dynamic thumb color.
                  trackColor: MaterialStateProperty.all(
                      Colors.redAccent), // Track color for better visibility.
                  splashRadius:
                      28, // Radius of the ripple effect when the switch is toggled.
                ),
              ],
            ),
          ),
          bottomNavigationBar: BottomNavigationBar(
            ...
            items: const <BottomNavigationBarItem>[
              ...
              BottomNavigationBarItem(
                ...
                label:
                    'Settings', // Label for the settings navigation item, indicating the current page.
              ),
            ],
            ...
            onTap: (index) {
              ...
              if (index == 0) {
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const MyApp())); // Navigates to the chat page.
              } else if (index == 1) {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) =>
                            const StatusPage())); // Navigates to the status page.
              }
            },
          ),
        );
